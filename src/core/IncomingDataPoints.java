...
final class IncomingDataPoints implements WritableDataPoints {
   ...
   */
  IncomingDataPoints(final TsdbHbase tsdb) {
    this.tsdb = tsdb;
   ...
   */
  static byte[] rowKeyTemplate(final TsdbHbase tsdb,
                               final String metric,
  ...
  private Deferred<Object> addPointInternal(final long timestamp, final byte[] value,
    ...
    final PutRequest point = new PutRequest(tsdb.table, row, TsdbHbase.FAMILY,
